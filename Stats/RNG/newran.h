...
class Random  // uniform random number generator
{
 ...
 public:
  ...
  virtual const char* Name() const;    // identification
...
class Uniform : public Random {
 ...
 public:
  const char* Name() const;  // identification
  Uniform() {}               // set value
...
class SubtractedRandom : public MultipliedRandom {
  SubtractedRandom(Random& rv1x, Random& rv2x) : MultipliedRandom(rv1x, rv2x) {}
...
class DividedRandom : public MultipliedRandom {
  DividedRandom(Random& rv1x, Random& rv2x) : MultipliedRandom(rv1x, rv2x) {}
...
class AddedSelectedRandom : public Random {
 ...
 protected:
  Random* rv1;
  Random* rv2;
  AddedSelectedRandom(Random& rv1x, Random& rv2x) : rv1(&rv1x), rv2(&rv2x) {}
  void tDelete() {
    rv1->tDelete();
    rv2->tDelete();
    delete this;
 ...
 public:
  ...
  void load(int*, Real*, Random**);
  Real Next();
  friend AddedSelectedRandom& operator+(SelectedRandom&, SelectedRandom&);
  friend AddedSelectedRandom& operator+(AddedSelectedRandom&, SelectedRandom&);
  friend AddedSelectedRandom& operator+(SelectedRandom&, AddedSelectedRandom&);
